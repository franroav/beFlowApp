...
import { createOnePayment } from "../../../actions/paymentsActions";
import { create } from "../../../services/payments.service";
...
const Form = () => {
  ...
  const sendForm = async (e: any) => {
    ...
    const createPayment: any = await create(template);
    if (createPayment.error) {
      ...
      alert(
        "Mensaje insertado correctamente el pago" +
          JSON.stringify(createPayment._id)
      );
      history.push(`/payments`);
    }
  };
...
function PaymentCreate(): JSX.Element {
  return (
    <Fragment>
